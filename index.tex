...
\title{If Not Now, When?}
\subtitle{The world needs us to repair it; and it needs it now}
\author{Union for Reform Chinese Culture (URCC)}

\maketitle

\section{What I Write}
\href{./HebrewHTML/IvriLider-ZachitiLeehov.html}{Ivri Lider: \textit{Zachiti Leehov}} February 10, 2026

\href{./assets/output/202508Abundance.html}{Letter to the Editor: \textit{Abundance for the 99 Percent} in \textit{Jacobin}---Why centrism still works} August 4, 2025

\href{./assets/output/202508DebateOnPhilosophyPaulGrahamPG.html}{A Debate on How to Do
Philosophy---Paul Graham vs. James Somers: Is philosophy more than a word salad?} August 5, 2025

\href{./assets/output/202508SandelTyrannyOfMerit.html}{Meritocracy yet to be defeated: A rebuke against Michael Sandel} August 24, 2025
